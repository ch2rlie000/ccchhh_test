...
loadMenus()
{
	...
	{
		self addOption("Chinchilla - H2M", 0, "Main Menu", ::newMenu, "Main Menu");
		self addOption("Chinchilla - H2M", 1, "Game Options", ::newMenu, "Game Options");
		self addOption("Chinchilla - H2M", 2, "Binds", ::newMenu, "Binds");
		self addOption("Chinchilla - H2M", 3, "Glitches", ::newMenu, "Glitches");
		self addOption("Chinchilla - H2M", 4, "Weapons", ::newMenu, "Weapons");
		self addOption("Chinchilla - H2M", 5, "Killstreaks", ::newMenu, "Killstreaks");
		self addOption("Chinchilla - H2M", 6, "EB Settings", ::newMenu, "EB Settings");
		self addOption("Chinchilla - H2M", 7, "Clients", ::newMenu, "Clients");
	}
	else
	{
		self addOption("Chinchilla - H2M", 0, "Main Menu", ::newMenu, "Main Menu");
		self addOption("Chinchilla - H2M", 1, "Binds", ::newMenu, "Binds");
		self addOption("Chinchilla - H2M", 2, "Glitches", ::newMenu, "Glitches");
		self addOption("Chinchilla - H2M", 3, "Weapons", ::newMenu, "Weapons");
		self addOption("Chinchilla - H2M", 4, "Killstreaks", ::newMenu, "Killstreaks");
		self addOption("Chinchilla - H2M", 5, "EB Settings", ::newMenu, "EB Settings");
	}
	
	self.backmenu["Main Menu"] = "Chinchilla - H2M";
	...
	self.backmenu["Game Options"] = "Chinchilla - H2M";
	...
	self.backmenu["Binds"] = "Chinchilla - H2M";
	...
	self.backmenu["Glitches"] = "Chinchilla - H2M";
	...
	self.backmenu["EB Settings"] = "Chinchilla - H2M";
	...
	self.backmenu["Weapons"] = "Chinchilla - H2M";
	...
	self addOption("Assault Rifles", 0, "M4A1", ::giveWeapon_wrapper, "m4_mp");
	...
	self.backmenu["Killstreaks"] = "Chinchilla - H2M";
	...
	self.backmenu["Clients"] = "Chinchilla - H2M";
...
menuOpen()
{
    ...
    self.title = self createText("objective", 1.7, "center", "center", 0, -65, 2, (1,0,0), 0, "Chinchilla - H2M");
    self.title affectElement("alpha",0.2,1);
    self.current = "Chinchilla - H2M";
